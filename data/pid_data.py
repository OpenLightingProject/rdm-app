...
MANUFACTURER_PIDS = [
  ...
  {'id': 0x20b9,
   ...
   'pids': [
      ...
      {'get_request': {'items': []},
       'get_response': {'items': [
                          {'name': 'CCT_value', 'type': 'float32'},
                        ]},
       'get_sub_device_range': 2,
       'name': 'CCT_ADJUST',
       'set_request': {'items': [{'name': 'CCT_value', 'type': 'float32',
                                  'range': [(2800, 10000)]}]},
       'set_response': {'items': []},
       'set_sub_device_range': 1,
       'link': '',
      ...
      {'get_request': {'items': []},
       'get_response': {'items': [
                          {'name': 'GN_value', 'type': 'float32'},
                        ]},
       'get_sub_device_range': 2,
       'name': 'GN_ADJUST',
       'set_request': {'items': [{'name': 'GN_value', 'type': 'float32', 'range': [(-1, 1)]}]},
       'set_response': {'items': []},
       'set_sub_device_range': 1,
       'link': '',
