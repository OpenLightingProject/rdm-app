...
MANUFACTURER_PIDS = [
  ...
  {'id': 0x20b9,
   ...
   'pids': [
      ...
      {'get_request': {'items': []},
       'get_response': {'items': [
                          {'name': 'CCT_value', 'type': 'uint16'},
                        ]},
       'get_sub_device_range': 2,
       'name': 'CCT_ADJUST',
       'set_request': {'items': [{'name': 'CCT_value', 'type': 'uint16',
                                  'range': [(2800, 10000)]}]},
       'set_response': {'items': []},
       'set_sub_device_range': 1,
       'link': '',
       'notes': 'Adjust the CCT Value',
       'value': 0x8003},
      {'get_request': {'items': []},
       'get_response': {'items': [
                          {'name': 'GN_value', 'type': 'int8'},
                        ]},
       'get_sub_device_range': 2,
       'name': 'GN_ADJUST',
       'set_request': {'items': [{'name': 'GN_value', 'type': 'int8', 'range': [(-1, 1)]}]},
       'set_response': {'items': []},
       'set_sub_device_range': 1,
       'link': '',
       'notes': 'Adjust the GN Value',
       'value': 0x8004},
      {'get_request': {'items': []},
       'get_response': {'items': [
