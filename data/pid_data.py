  ...
  {'id': 17232,
   ...
   'pids': [ { 'get_request': { 'items': []},
			 ...
			 { 'get_request': { 'items': []},
			   ...
			   'value': 34332},
			 { 'get_request': { 'items': []},
			'get_response': { 'items': [ { 'name': 'channel_mode_pixels', 'type': 'uint8', 'labels': [(0, 'Diabled'), (1, 'RGB'), (2, 'RGBW')]}]},
			   'get_sub_device_range': 2,
			   'name': 'CP_CHNLMODE_PIXELS',
			   'set_request': { 'items': [ { 'name': 'channel_mode_pixels', 'type': 'uint8', 'labels': [(0, 'Diabled'), (1, 'RGB'), (2, 'RGBW')]}]},
			   'set_response': { 'items': []},
			   'set_sub_device_range': 1,
			   'value': 34335},
    ],
...
#       'value': 0x8601},
  ...
  { 'id': 20562,
    ...
    'pids': [ {'get_request': {'items': []},
	  ...
	  {'get_request': {'items': []},
       'get_response': {'items': [{'name': 'diable_mechanics', 'type': 'uint8'}]},
       'get_sub_device_range': 0,
       'name': 'DISABLE_MECHS',
       'set_request': {'items': [{'name': 'diable_mechanics', 'type': 'uint8'}]},
       'set_response': {'items': []},
       'set_sub_device_range': 0,
       'link': '',
       'value': 36864},
