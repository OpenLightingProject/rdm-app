   ...
   'pids': [
      ...
      {'get_request': {'items': []},
       'get_response': {'items': [{'name': 'seconds', 'type': 'uint8',
                                   'range': [(0, 241)],
                                   'enums': [(0, 'Always On'), (241, 'Always Off')],
                                   }]},
       'get_sub_device_range': 0,
...
ESTA_PIDS = [
 ...
 {'get_request': {'items': [
  ...
  'get_response': {'items': [
    ...
    {'name': 'endpoint_function', 'type': 'uint8',
     'enums': [(0, 'Disabled'), (1, 'Input'), (2, 'Output')]},
  ]},
  'get_sub_device_range': 0,
 ...
 {'get_request': {'items': [
  ...
  'get_response': {'items': [
    {'name': 'endpoint_id', 'type': 'uint16', 'range': [(1, 0xfffe)]},
    {'name': 'device_count', 'type': 'uint16', 'enums': [(0xffff, 'Not Supported')]},
    {'name': 'discovery_state', 'type': 'uint8',
     'enums': [(0, 'Not Run'), (1, 'Completed'),
               (2, 'Incremental'), (3, 'Full')]},
  ]},
  'get_sub_device_range': 0,
  'name': 'INITIATE_DISCOVERY',
  'set_request': {'items': [
    {'name': 'endpoint_id', 'type': 'uint16',
     'range': [(1, 0xffff)],
     'enums': [(0xffff, 'All Endpoints')]},
