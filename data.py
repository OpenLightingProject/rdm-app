...
pids = [{'get_request': {'is_repeated': False, 'items': []},
 ...
 {'get_request': {'is_repeated': False, 'items': []},
  ...
  'set_request': {'is_repeated': False,
                  'items': [{'name': u'year', 'type': 'uint16', 'range': [(2003, 65535)]},
                    {'name': u'month', 'type': 'uint8', 'range': [(1, 31)]},
                    {'name': u'day', 'type': 'uint8', 'range': [(1, 23)]},
 ...
 {'get_request': {'is_repeated': False,
  ...
  'value': 512},
 {'get_request': {'is_repeated': False,
                  'items': [{'name': u'status_type', 'type': 'uint8', 'enums': [
 ...
 {'name': u'RESET_DEVICE',
  'set_request': {'is_repeated': False,
                  'items': [{'name': u'reset_mode', 'type': 'uint8', 'enums': [
                    (1, 'Warm'), (0xff, 'Cold')]
                 }]},
  'set_response': {'is_repeated': False, 'items': []},
  'set_sub_device_range': 1,
 ...
 {'get_request': {'is_repeated': False, 'items': []},
  ...
  'set_request': {'is_repeated': False,
                  'items': [{'name': u'dmx_address', 'type': 'uint16', 'range': [
                    (1, 512)],
                  }]},
  'set_response': {'is_repeated': False, 'items': []},
  'set_sub_device_range': 1,
 ...
 {'get_request': {'is_repeated': False, 'items': []},
  ...
  'set_request': {'is_repeated': False,
                  'items': [{'name': u'invert_status', 'type': 'uint8', 'enums': [
                      (0, 'Off'), (1, 'On'), (2, 'Auto')]
                  }]},
  'set_response': {'is_repeated': False, 'items': []},
  'set_sub_device_range': 1,
 ...
 {'get_request': {'is_repeated': False, 'items': []},
  ...
  'value': 4145},
 {'get_request': {'is_repeated': False,
                  'items': [{'name': u'personality', 'type': 'uint8', 'range': [
                    (0, 0xff)]
                  }]},
  'get_response': {'is_repeated': False,
