   ...
   'pids': [
      ...
      {'get_request': {'items': []},
       ...
       'notes': ('Enable auto play for stand alone mode when power is applied.'
                 ' This requires STAND_ALONE_OPERATION_ENABLE to be set.'),
       'value': 0x8102},
      {'get_request': {'items': []},
       'get_response': {'items': [{'name': 'mode',
                                   'type': 'uint8',
      ...
      {'get_request': {'items': []},
       ...
       'set_sub_device_range': 0,
       'link': '',
       'notes': ('Enable the light sensor to start the stand alone program. '
      ...
      {'name': 'RUN_PROGRAM',
       ...
       'set_sub_device_range': 0,
       'link': '',
       'notes': 'Start running the programmed scenes in the stand along program.',
       'value': 0x8208},
      {'name': 'SCENE_NUMBER',
       'get_request': {'items': []},
       'get_response': {'items': [{'name': 'current_scene', 'type': 'uint8'},
       ...
       'get_sub_device_range': 0,
       'link': '',
       'notes': 'Get the current scene number',
       'value': 0x820A},
      {'get_request': {'items': []},
...
#       'value': 0x},
      ...
      {'get_request': {'items': []},
       ...
       'notes': ('Controls if CMY blackout is enabled. Enabling this setting '
                 'will enable CMY blackout 3 seconds after the shutter closes '
                 'to 0% intensity.'),
       'value': 0x830d},
      {'get_request': {'items': []},
      ...
      {'get_request': {'items': []},
       'get_response': {'items': [{'name': 'focus_tracking',
                                   ...
                                   'enums': [(0, 'Focus tracking off'),
                                             (1, 'Focus tracking range is linear'),
      ...
      {'get_request': {'items': []},
       ...
       'value': 0x8402},
      {'get_request': {'items': []},
       'get_response': {'items': [{'name': 'enabled', 'type': 'uint16', 'range':  [(0, 360)]}]},
       'get_sub_device_range': 0,
       'name': 'PAN_LIMITATION_MINIMUM',
       'set_request': {'items': [{'name': 'enabled', 'type': 'uint16', 'range': [(0, 360)]}]},
       'set_response': {'items': []},
       'set_sub_device_range': 0,
       'link': '',
      ...
      {'get_request': {'items': []},
       ...
       'value': 0x8404},
      {'get_request': {'items': []},
       'get_response': {'items': [{'name': 'enabled', 'type': 'int16', 'range': [(-134, 134)]}]},
       'get_sub_device_range': 0,
       'name': 'TILT_LIMITATION_MINIMUM',
       'set_request': {'items': [{'name': 'enabled', 'type': 'int16', 'range': [(-134, 134)]}]},
       'set_response': {'items': []},
       'set_sub_device_range': 0,
       'link': '',
      ...
      {'get_request': {'items': []},
       ...
       'set_sub_device_range': 0,
       'link': '',
       'notes': 'Used to enable the follow spot lock',
       'value': 0x8500},
      {'get_request': {'items': []},
      ...
      {'get_request': {'items': []},
       ...
       'set_sub_device_range': 0,
       'link': '',
       'notes': 'Control the pan lock for follow spot mode',
       'value': 0x8502},
      {'get_request': {'items': []},
       'get_response': {'items': [{'name': 'locked', 'type': 'bool'}]},
       'get_sub_device_range': 0,
       ...
       'set_sub_device_range': 0,
       'link': '',
       'notes': 'Control the tilt lock for follow spot mode',
       'value': 0x8503},
      {'get_request': {'items': [{'name': 'string_number', 'type': 'uint16'}]},
       ...
       'value': 0x8601},
      {'get_request': {'items': []},
       'get_response': {'items': [{'name': 'regulate', 'type': 'bool'}]},
       'get_sub_device_range': 0,
       'name': 'REGULATE_LAMP_FAN',
       'set_request': {'items': [{'name': 'regulate', 'type': 'bool'}]},
       'set_response': {'items': []},
       'set_sub_device_range': 0,
       'link': '',
      ...
      {'get_request': {'items': []},
       ...
       'set_sub_device_range': 0,
       'link': '',
       'notes': 'Set the lamp cooling level.',
       'value': 0x8602},
      {'get_request': {'items': []},
       'get_response': {'items': [{'name': 'mode',
                                   'type': 'uint8',
