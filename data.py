...
pids = [
 ...
 {'name': u'CAPTURE_PRESET',
  'set_request': {'items': [
    {'name': u'scene', 'type': 'uint16', 'range': [(0x1, 0xfffe)]},
    {'name': u'fade_up_time', 'type': 'uint16', 'multiplier': -1,},
    {'name': u'fade_down_time', 'type': 'uint16', 'multiplier': -1,},
    {'name': u'wait_time', 'type': 'uint16', 'multiplier': -1}]},
  'set_response': {'items': []},
  'set_sub_device_range': 1,
  'value': 4144},
 {'get_request': {'items': []},
 ...
 {'get_request': {'items': []},
  ...
  'value': 1538},
 {'get_request': {'items': []},
  'get_response': {'items': [{'name': u'identify_mode', 'type': 'uint8'}]},
  'get_sub_device_range': 2,
  'name': u'IDENTIFY_MODE',
  'set_request': {
